...
allowed_roles = {
    YOU_ID: ["clear", "mute", "unmute", "delnick", "addnick", "ban", "unban", "permban", "unpermban", "addrole", "delrole", "kick", "move"],
    YOU_ID: ["clear", "mute", "unmute", "delnick", "addnick", "ban", "unban", "permban", "unpermban", "addrole", "delrole", "kick", "move"],
    YOU_ID: ["clear", "mute", "unmute", "delnick", "addnick", "ban", "unban", "permban", "unpermban", "addrole", "delrole", "kick", "move"],
    YOU_ID: ["clear", "mute", "unmute", "delnick", "addnick", "ban", "unban", "permban", "unpermban", "addrole", "delrole", "kick", "move"],
    YOU_ID: ["clear", "mute", "unmute", "addnick", "ban", "unban", "permban","kick", "unpermban", "move"],
    YOU_ID: ["clear", "mute", "unmute", "delnick", "addnick", "ban", "unban", "move"],
    YOU_ID: ["clear", "mute", "unmute", "delnick", "addnick", "ban", "move"],
...
async def com_list(ctx):
    allowed_commands = True  # Предположим, что у пользователя есть разрешенные команды
    ...
    command_descriptions = {
        ...
        "move": "@user ID канала | Перемещает пользователя в указанный канал.",
...
async def delnick(ctx, member: discord.Member):
    try:
        ...
        embed = discord.Embed(
            title="Успешно",
            description=f"Никнейм пользователя {member.mention} был удален.",
            color=discord.Color.green()
        )
        await ctx.send(embed=embed)
    except discord.Forbidden:
...
@bot.command()
async def move(ctx, member: discord.Member = None, channel_id: int = None):
    if member is None or channel_id is None:
        embed = discord.Embed(
            title="Ошибка",
            description="Пожалуйста, укажите все необходимые аргументы (участник и ID канала).",
            color=discord.Color.red()
        )
        await ctx.send(embed=embed)
        return
    ...
    try:
        ...
        embed = discord.Embed(
            ...
            description=f"Участник {member.name} был перемещён в канал {channel.name}.",
            color=discord.Color.green()
        )
        await ctx.send(embed=embed)
    except discord.Forbidden:
        embed = discord.Embed(
            title="Ошибка",
            description="У меня нет прав для перемещения участника.",
            color=discord.Color.red()
        )
        await ctx.send(embed=embed)
    except discord.HTTPException as e:
        embed = discord.Embed(
            title="Ошибка HTTP",
            description=f"Произошла ошибка HTTP: {e}",
            color=discord.Color.red()
        )
        await ctx.send(embed=embed)
